...
export const baseURL = "https://kaapoa.co.ke/wp-json/wc/v3/";
...
instance.interceptors.request.use(
    (config) => {
        const username = "ck_2c4c455fbefc32839a14daddb5f0038dc420229a";
        const password = "cs_059cbe542832e85e8da3a420342199a17c6c3d09";
        config.auth = {
            username,
            password,
        };
